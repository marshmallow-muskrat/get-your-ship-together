...
2. **Containment Protocol (survivor experiment)** — Endless one-map high-score survival: upward timer, multi-model bosses every two minutes (red aura), automatic weapons, XP level-ups (large choice UI), Dodge (triple distance) / Repulsor / Afterburner / Mech, ship-sized Energy pickup, thruster power scaling, Breach Shielding, UI Scale, and **per-hero** local top-10 leaderboards. Death ends the run (no eight-minute victory). See `docs/SURVIVOR_MODE_VERTICAL_SLICE.md`.
